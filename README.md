...
> Приложение работает стабильно, но все еще в разработке. Известны проблемы со скоростью работы и подтормаживанием интерфейса - в ближайшее время займусь именно оптимизацией и повышением скорости работы.
